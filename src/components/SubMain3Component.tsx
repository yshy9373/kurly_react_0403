...
export default function SubMain3Component({알뜰쇼핑}: any) {
                ...
                <div className="container">
                    <div className="gap">
                        ...
                        <div className="content">
                            <a href="!#"><img src="./img/main3/main_img.jpg" alt="" /></a>
                        </div>
                    </div>
                </div>
            </section>
                                                    ...
                                                    <div className="col-gap">
                                                        <div className="wrap">
                                                            <div className="img-box">
                                                                <img src={`./img/main3/${item.상품이미지}`} alt="" />
                                                                <a href="!#" className='cart-btn'><img src={`./img/main3/${item.카트이미지}`} alt="" /></a>
                                                            </div>
