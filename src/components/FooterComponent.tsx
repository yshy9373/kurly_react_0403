                    ...
                    <div className="row1-1">
                        <div className="left">
                            <ul>
                                ...
                                <li>
                                    <h1><a href="tel:1644-1107">1644-1107</a><span>월~토요일 오전 7시 - 오후 6시</span></h1>
                                </li>
                                <li>
                                    <a href="!#">카카오톡 문의</a>
                                    <p>월~토요일&nbsp;<i>|</i>&nbsp;오전7시 - 오후6시<br />일/공휴일&nbsp;<i>|</i>&nbsp;오전7시 - 오후1시</p>
                                </li>
                                <li>
                                    <a href="!#">1:1 문의</a>
                                ...
                                <li>
                                    <a href="!#">대량주문 문의</a>
                                    <p>월~금요일&nbsp;<i>|</i>&nbsp;오전9시 - 오후6시<br />점심시간&nbsp;<i>|</i>&nbsp;낮12시- 오후1시</p>
                                </li>
                                <div>
                        ...
                        <div className="right">
                            <ul>
                                ...
                                <li>
                                    <a href="!#"><img src='./img/footer/ico_instagram.png' alt="" /></a>
                                    <a href="!#"><img src='./img/footer/ico_fb.png' alt="" /></a>
                                    <a href="!#"><img src='./img/footer/ico_blog.png' alt="" /></a>
                                    <a href="!#"><img src='./img/footer/ico_naverpost.png' alt="" /></a>
                                    <a href="!#"><img src='./img/footer/ico_youtube.png' alt="" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
